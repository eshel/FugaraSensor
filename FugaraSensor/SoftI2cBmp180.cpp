...
SoftI2cBmp180::SoftI2cBmp180(byte sdaPin, byte sclPin) : i2c()
// Base library type
{
	_sdaPin = sdaPin;
	_sclPin = sclPin;
...
// Initialize library for subsequent pressure measurements
{
	...
	//Wire.begin();
	//i2c.begin();
	i2c.setPins(_sclPin, _sdaPin, true);
...
char SoftI2cBmp180::readInt(char address, int16_t &value)
...
char SoftI2cBmp180::readUInt(char address, uint16_t &value)
...
char SoftI2cBmp180::readBytes(unsigned char *values, char length)
...
char SoftI2cBmp180::writeBytes(unsigned char *values, char length)
...
char SoftI2cBmp180::startTemperature(void)
...
char SoftI2cBmp180::getTemperature(double &T)
...
char SoftI2cBmp180::startPressure(char oversampling)
...
char SoftI2cBmp180::getPressure(double &P, double &T)
...
double SoftI2cBmp180::sealevel(double P, double A)
...
double SoftI2cBmp180::altitude(double P, double P0)
...
char SoftI2cBmp180::getError(void)
